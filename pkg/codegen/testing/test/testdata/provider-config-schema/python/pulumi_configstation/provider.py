...
class Provider(pulumi.ProviderResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["secret_sandwiches"] = None if pulumi.Output.from_input(secret_sandwiches).apply(pulumi.runtime.to_json) if secret_sandwiches is not None else None is None else pulumi.Output.secret(pulumi.Output.from_input(secret_sandwiches).apply(pulumi.runtime.to_json) if secret_sandwiches is not None else None)
